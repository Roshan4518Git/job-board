  ...
  return (
    <>
      <div className="md:flex md:min-h-screen md:overscroll-none overflow-hidden">
        <div className="md:relative md:bg-white md:w-3/5 ">
          ...
          <div className="md:text-center flex flex-wrap flex-col justify-center  lg:mr-10 lg:ml-10 md:pl-20 md:pr-20 p-10">
        ...
        <div className="md:bg-zinc-200  md:w-2/5   relative invisible md:visible">
          <div className="w-full h-auto flex justify-center">
            <img src={minion} id="anchor" className="absolute h-4/5 top-5" />
            <img
              src={eyeball}
              id="eyeball"
